    ...
    <AdminLayout activePage="dashboard" onNavigate={navigateTo} onLogout={onLogout}>
        ...
        <section className="directory-panel">
          <div className="directory-toolbar">
            <div className="search-filter"><label><span><AppIcon name="search" size={14} /></span><input placeholder="Search members by name, ID or email..." /></label><button><AppIcon name="filter" size={14} /> Filter</button></div>
            <button className="add-member" onClick={() => navigateTo("member-profile")}><AppIcon name="plus" size={15} /> Add Member</button>
          </div>
